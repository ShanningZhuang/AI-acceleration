...
σ(tx)σ(ty)pwphbhbwbw=pwebh=phecxcybx=σ(tx)+cxby=σ(ty)+cytwthMean Average PrecisionFrames Per SecondR-CNNYOLOFast R-CNNFaster R-CNNFaster R-CNNResnetSSD512SSD300YOLOv280706005010030batch norm?
hi-res classiﬁer?
convolutional?
anchor boxes?
new network?
